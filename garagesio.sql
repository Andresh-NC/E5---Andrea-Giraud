...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 13 nov. 2024 à 20:42
...
INSERT INTO `categorie` (`ID`, `ID_marque`, `Nom_modele`) VALUES
...
CREATE TABLE IF NOT EXISTS `locations` (
  ...
  `nombre_jours_location` int GENERATED ALWAYS AS (((to_days(`date_fin_location`) - to_days(`date_debut_location`)) + 1)) STORED,
...
(1, 2, 2, '298457NC', '2013-06-17', '1885000.00', '2023-08-11', 147, 'La Ford Fiesta, compacte et polyvalente, offre une conduite dynamique et des fonctionnalités innovantes, en faisant un choix idéal pour la ville et les déplacements quotidiens.', 3),
(3, 2, 6, '938749NC', '2022-04-07', '758200.00', '2024-11-03', 150, 'Audi A4 est une berline de luxe compacte. Elle se distingue par son design élégant, sa qualité de finition et ses performances dynamiques.', 0),
(4, 2, 3, '374926NC', '2020-09-26', '450000.00', '2023-09-13', 135, 'La Renault Mégane est une voiture compacte populaire qui correspond bien aux critères demandés.', 5),
(5, 1, 5, '930537NC', '2019-05-08', '500000.00', '2024-01-05', 100, 'La Fiat 500 est une citadine emblématique, conçue pour une mobilité urbaine agile et économique.', 2);
COMMIT;
