...
// Étape 1 : Demande de l'immatriculation du véhicule
...
// Étape 2 : Mise à jour des informations du véhicule
...
<body>
    <h2>Modifier les données d'un véhicule</h2>

    <!-- Étape 1 : Formulaire pour saisir l'immatriculation -->
    <form method="post">
    ...
    <?php if (isset($vehicule)) : ?>
        <!-- Étape 2 : Affichage du formulaire de modification avec les données actuelles -->
        <form method="post">
